...
class ImageCache(blobstore_handlers.BlobstoreDownloadHandler):
    ...
    def get(self, source_url):
        # Since we've moved to Google Cloud-Storage, and this wasn't a much used feature
        # I've disabled it until further notice
        logging.error("Can't to load image from cache for source url, redirecting: %s" % source_url)
