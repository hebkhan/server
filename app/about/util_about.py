...
TEAM = [
    ...
    (u"yarden", u"ירדן",
    u"""
    ירדן אסא גילתה את קאהן אקדמי בעקבות חיפוש ברשת של סרטון שיסביר לה מה זה "בינארי".
    ...
    מכל שכבה חברתית ובכל מקום בארץ. מאז ששמע על אקדמית קאהן לפני שנתיים ומאז הוא מתנדב בעמותה בריכוז מערך התרגום והתכנות של התרגילים.
    """),

    (u"roi", u"רועי",
    u"""
    רועי חרמוני נדבק בחיידק ההוראה בזמן הצבא ומאז משתדל לעמוד מול כיתה כמה שיותר.
    מאז ששמע על אקדמיית קאהן הבין שעתיד החינוך בעולם נמצא מול מחשב ולא רק מול המורה.
